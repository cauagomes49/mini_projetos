...
from aluno.base.contato import Contato
from aluno.g_contatos import GContatos
from cliente.circulo_not_found_exception import CirculoNotFoundException
from cliente.contato_not_found_exception import ContatoNotFoundException
